...
class Test1 {
  ...
  public static void run2() {
        ...
        System.out.println("StringArray[1] = " + Array.get(array, 1));

        Class c1 = array.getClass();
        Class c2 = c1.getComponentType();
        int[] array2 = (int[]) Array.newInstance(int.class, 3);
		Test1[] array3 = (Test1[]) Array.newInstance(Test1.class, 3);

		int[] sizes = {3, 5, 6};
		Test1[][][] multi = (Test1[][][]) Array.newInstance(Test1.class, sizes);
  }
  ...
  public static void run() {
    ...
    try {
        ...
        m1 = c.getDeclaredMethods();
        Method m2 = c.getMethod("show", new Class[0]);
        m2 = c.getDeclaredMethod("show", new Class[0]);
        Field[] f1 = c.getFields();
        f1 = c.getDeclaredFields();
        Field f2 = c.getField("o2");
        f2 = c.getDeclaredField("o2");
        ...
        else System.out.println("con not null");
        Constructor[] cons = c.getConstructors();
        cons = c.getDeclaredConstructors();

        ClassLoader cLoader = c.getClassLoader();
        if(cLoader == null) System.out.println("null");
        else System.out.println("not null " + cLoader.getClass().getName());

        URL url = c.getResource("Test2.class");
        if(url == null) System.out.println("url null");
        else System.out.println("url not null");

        test1(c);
        test2(new Test1());
        test3(new String[] {"admin"});

        Class c3 = (new B()).getClass().getSuperclass();
        Class[] c4 = (new A()).getClass().getInterfaces();
    } catch (Exception e) { System.out.println("ERRRRR " + e.getMessage()); }
  }

  public Test1() { System.out.println("cons in"); }
  public Test1(Integer in) { System.out.println("cons integer"); }
  public static void test1(Class c) { System.out.println("@1" + c.getName()); }
  public static void test2(Object o) { System.out.println("@2" + o.getClass().getName()); }
  public static void test3(Object o) {
        Class c = o.getClass().getComponentType();
        if(c != null) System.out.println("CT " + c.getName());
        else System.out.println("CT null");
  }
  public Integer show() { return new Integer(42); }
}
...
class Test31 {
  ...
  public static void run() {
    try {
      ...
      o1 = m.newInstance(new Object[]{i});
      m = c.getConstructor(new Class[]{});
